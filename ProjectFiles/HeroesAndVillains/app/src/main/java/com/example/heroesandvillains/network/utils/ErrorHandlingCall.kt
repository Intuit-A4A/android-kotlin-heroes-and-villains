 ...
 *
 * Custom Retrofit callAdapter to handle the API call Success and Error states.
 */
class ErrorHandlingCall<T : Any>(
    private val call: Call<T>
) {
    companion object {
        private const val TAG = "ErrorHandlingCall"
        private const val LOGGING_REQUEST_URL_KEY = "request URL"
        private const val LOGGING_RESPONSE_CODE_KEY = "response code"
        private const val LOGGING_RESPONSE_MESSAGE_KEY = "response message"
     ...
     */
    private suspend fun sendRequest(): Response<T> = try {
    ...
    /**
     * Handles any deserialization errors of the response body, service error responses, and other
